...
Route::get('/perizinan/standar-pelayanan', [\App\Http\Controllers\ServiceStandardController::class, 'index'])->name('permit.service-standard');

/* REFORMASI BIROKRASI */
Route::get('/reformasi-birokrasi', [\App\Http\Controllers\ReformationController::class, 'integrityZone'])->name('reformation.integrity-zone');

/* Service Standard PDF routes (used by Blade view) */
Route::get(
    '/perizinan/standar-pelayanan/pdf',
    [\App\Http\Controllers\ServiceStandardController::class, 'streamPdf']
)->name('service-standard.stream');

Route::get(
    '/perizinan/standar-pelayanan/download',
    [\App\Http\Controllers\ServiceStandardController::class, 'downloadPdf']
)->name('service-standard.download');
