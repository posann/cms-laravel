...
<section class="py-8 md:py-12 lg:py-16 bg-gray-100">
    <div class="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
        <div class="flex items-center justify-between mb-8">
            <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 font-roboto">Siaran Pers</h2>
            <a href="#"
                class="group flex items-center gap-3 text-gray-800 hover:text-primary-700 transition-colors duration-300 font-roboto">
                <span class="text-base md:text-lg font-medium">Lihat Semua Siaran Pers</span>
                <div
