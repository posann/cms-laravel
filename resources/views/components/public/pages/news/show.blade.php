<x-public.main>
    ...
    <div class="m-0 mx-auto h-96 w-full max-w-3xl overflow-hidden shadow-sm rounded-lg mt-[-140px] z-[9999] relative">
        <img src="{{ count($news->media) > 0 ? $news->media[0]->original_url : asset('images/berita/Dampingin Presiden Prabowo.png') }}"
            alt="{{ count($news->media) > 0 ? $news->media[0]->name : '' }}"
            class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
    </div>

    <div class="m-0 mx-auto w-full py-12 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
