            ...
            <div class="grid grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 gap-x-16 gap-y-12">
                ...
                <div class="bg-neutral-100 rounded-lg p-8">
                    ...
                    <p class="text-gray-700 text-base md:text-lg leading-relaxed">
                        Terwujudnya pengelolaan energi dan sumber daya mineral yang berkeadilan, berkelanjutan, dan berdaya saing untuk kemakmuran rakyat serta kedaulatan energi nasional.
                    </p>
                </div>
                ...
                <div class="bg-neutral-100 rounded-lg p-8">
                    ...
                    <ul class="list-decimal pl-6 space-y-4 text-gray-700 text-base md:text-lg leading-relaxed">
                        <li>Mengelola potensi energi dan sumber daya mineral secara optimal, transparan, dan berkelanjutan untuk kesejahteraan masyarakat.</li>
                        <li>Mendorong kemandirian energi melalui pengembangan energi baru terbarukan dan efisiensi energi.</li>
                        <li>Memperkuat infrastruktur energi untuk menjamin akses energi yang merata dan terjangkau bagi seluruh wilayah Indonesia.</li>
                        <li>Menjaga kelestarian lingkungan hidup dalam setiap kegiatan eksplorasi, produksi, dan pemanfaatan sumber daya energi dan mineral.</li>
                        <li>Mengembangkan tata kelola pemerintahan yang baik, profesional, dan akuntabel di sektor energi dan sumber daya mineral.</li>
                    </ul>
                </div>
            </div>
        </div>
