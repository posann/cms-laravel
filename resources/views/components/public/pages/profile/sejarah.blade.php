        ...
        <div>
            <div class="relative container mx-auto max-w-[90rem] py-12 px-4 sm:px-6 md:px-8">
                ...
                <div class="space-y-8 sm:space-y-10 md:space-y-12">
                    @foreach ($timelines as $timeline)
                        <div class="relative flex items-center gap-x-1 md:gap-x-6 lg:gap-x-8">
                            <div class="min-w-[55px] max-sm:max-w-[55px] sm:min-w-[65px] md:min-w-[84px]">
                                @if(strpos($timeline->year, ' ') !== false)
                                    <div class="text-base sm:text-xl md:text-2xl font-bold text-gray-800 leading-snug text-left flex-wrap">{{$timeline->year }}</div>
                                @else
                                    <div class="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 tracking-tight whitespace-nowrap">{{ $timeline->year }}</div>
                                @endif
                            </div>
                    ...
                    @endforeach
                        <!-- Fallback to hardcoded data if no timeline data exists -->
                        <!-- Item 1945 -->
                        {{-- <div class="relative flex items-center gap-x-1 md:gap-x-6 lg:gap-x-8">
                            <div class="min-w-[55px] max-sm:max-w-[55px] sm:min-w-[65px] md:min-w-[84px]">
