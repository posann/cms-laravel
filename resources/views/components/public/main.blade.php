...
<body>
    ...
    @else
        @if (isset($siteSettings->notification_popup) && $siteSettings->notification_popup)
            <div id="image-popup" class="image-popup">
                <div class="image-popup-content">
                    <span class="image-popup-close-btn">&times;</span>
                    <a href="https://perizinan.esdm.go.id/minerba/" target="_blank">
                        <img src="https://minerba.sahabatngoding.com/public/images/image-popup.jpg" alt="Iklan Promosi">
                    </a>
                </div>
            </div>
        @endif
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const isPopupClosed = localStorage.getItem('imagePopupClosed');

            // Tampilkan popup jika belum pernah ditutup
            if (!isPopupClosed) {
            ...
            function closePopup() {
                ...
                localStorage.setItem('imagePopupClosed', 'true');
            }

            // Menutup saat tombol close diklik
            closeBtn.addEventListener('click', closePopup);

            // Menutup saat area di luar popup diklik
            ...
            // Menutup saat tombol ESC ditekan
