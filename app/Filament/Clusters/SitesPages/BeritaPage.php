...
class BeritaPage extends Page implements HasForms
{
    ...
    protected function loadFileContent(): void
    {
        try {
            ...
            if (File::exists($mainFilePath)) {
                ...
                Log::warning("Berita page file not found: {$mainFilePath}");
            }
        } catch (Exception $e) {
            Log::error('Error loading berita page content: ' . $e->getMessage());
            $this->fileContent = '';
    ...
    public function save(): void
    {
        ...
        try {
            ...
            Notification::make()
                ...
                ->body('The berita page content has been updated.')
                ->success()
                ->send();

            // Log the action
            Log::info('Berita page content updated by user: ' . auth()->user()->email);
            ...
            Log::error('Error saving berita page content: ' . $e->getMessage());
    ...
    {
        return resource_path('views/components/superduper/pages/berita.blade.php');
    }
    ...
    {
        return 'Manage your website\'s berita page content.';
    }
