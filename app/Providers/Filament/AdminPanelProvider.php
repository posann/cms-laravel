...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->brandName("ESDM")
            ->brandLogo(asset("images/logo-esdm.png"))
            ->favicon(asset('images/icon-esdm.png'))
            ...
            ->renderHook('panels::head.start', fn () => view('filament.components.force-light-theme'))
            ->navigationGroups([
